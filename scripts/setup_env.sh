...
read -p "Agent Context Set ID (AlloyDB): " AGENT_CONTEXT_SET_ID_ALLOYDB
...
read -p "Agent Context Set ID (Spanner): " AGENT_CONTEXT_SET_ID_SPANNER
...
read -p "Agent Context Set ID (Cloud SQL PG): " AGENT_CONTEXT_SET_ID_CLOUDSQL_PG
...
read -p "Agent Context Set ID (Cloud SQL MySQL): " AGENT_CONTEXT_SET_ID_CLOUDSQL_MYSQL
...
DB_NAME=$DB_NAME
AGENT_CONTEXT_SET_ID_ALLOYDB=$AGENT_CONTEXT_SET_ID_ALLOYDB
AGENT_CONTEXT_SET_ID_SPANNER=$AGENT_CONTEXT_SET_ID_SPANNER
AGENT_CONTEXT_SET_ID_CLOUDSQL_PG=$AGENT_CONTEXT_SET_ID_CLOUDSQL_PG
AGENT_CONTEXT_SET_ID_CLOUDSQL_MYSQL=$AGENT_CONTEXT_SET_ID_CLOUDSQL_MYSQL
